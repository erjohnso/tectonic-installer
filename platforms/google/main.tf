...
module "ignition-masters" {
  ...
  kubeconfig_gcs_location   = "${google_storage_bucket_object.kubeconfig.bucket}/${google_storage_bucket_object.kubeconfig.key}"
  assets_gcs_location       = "${google_storage_bucket_object.tectonic-assets.bucket}/${google_storage_bucket_object.tectonic-assets.key}"
